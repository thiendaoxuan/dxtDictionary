...
import com.vng.zing.testapp.model.webapp.AuthenModel;
 ...
 * @author namnq
 */
public class AuthenHandler extends HttpServlet {

	private static final Logger _Logger = ZLogger.getLogger(AuthenHandler.class);
	...
	private void doProcess(HttpServletRequest req, HttpServletResponse resp) {
		ThreadProfiler profiler = Profiler.createThreadProfilerInHttpProc("AuthenHandler", req);
		try {
			AuthenModel.Instance.process(req, resp);
		} catch (Exception ex) {
