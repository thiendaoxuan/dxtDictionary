...
public class HomePageHandler extends HttpServlet {
	...
	private static final Logger _Logger = ZLogger.getLogger(HomePageHandler.class);
	...
	private void doProcess(HttpServletRequest req, HttpServletResponse resp) {
		ThreadProfiler profiler = Profiler.createThreadProfilerInHttpProc("HomePageHandler", req);
		try {
			HomePageModel.Instance.process(req, resp);
		} catch (Exception ex) {
